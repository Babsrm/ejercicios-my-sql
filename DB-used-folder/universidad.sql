-- Active: 1667910674547@@127.0.0.1@3306@universidad
...
create table asignatura (
    ...
    tipo enum ('Obligatoria', 'Optativa', 'Básica') not null,
    curso TINYINT UNSIGNED not NULL,
    cuatrimestre TINYINT UNSIGNED not NULL,
    id_profesor int UNSIGNED,
    id_grado int UNSIGNED
);
...
constraint fk_profesor_id_departamento_departamento_id
foreign KEY(id_departamento) REFERENCES departamento(id);

alter table profesor ADD
constraint fk_profesor_profesor_id_persona_id
foreign KEY(id_profesor) REFERENCES persona(id);

alter table alumno_se_matricula_asignatura ADD
constraint fk_asma_id_Alumno_persona_id
foreign KEY(id_alumno) REFERENCES persona(id);

alter table alumno_se_matricula_asignatura ADD
constraint fk_asma_id_asignatura_asignatura_id
foreign KEY(id_asignatura) REFERENCES asignatura(id);

alter table alumno_se_matricula_asignatura ADD
constraint fk_asma_id_curso_escolar_curso_escolar_id
foreign KEY(id_curso_escolar) REFERENCES curso_escolar(id);

alter table asignatura ADD
constraint fk_asignatura_id_profesor_profesor_profesor_id
foreign KEY(id_profesor) REFERENCES profesor(id_profesor);

alter table asignatura ADD
constraint fk_asignatura_id_grado_grado_id_grado
